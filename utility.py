...
def print_save_metrics(model_name, dataset_name, param, y_true, y_pred):
    ...
    Parameters: model_name (str): A string that represents the name of the machine learning model used for
    predictions. dataset_name (str): A string that represents the name of the dataset used for evaluation. param (str
    or dict): A string or dictionary that represents the configuration parameters used in the model (e.g.,
    hyperparameters, settings). y_true (numpy array or list): A 1-dimensional numpy array or list containing the true
    labels. y_pred (numpy array or list): A 1-dimensional numpy array or list containing the predicted labels
    ...
    Excel File Saving: The function saves the computed metrics along with the model name, dataset name,
    and configuration parameters to an Excel file named 'output/risultati_modelli.xlsx'. The function creates or
    appends to the existing file based on its presence.
    ...
    average_accuracy = (recall_positive + recall_negative) / 2
