...
class TrainingCallback(tf.keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        val_loss, val_acc = self.model.evaluate(self.validation_data)
...
class MetricsCallback(tf.keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        print("Recall:", recall_score(true_masks, predicted_masks))
        print("F1-score:", f1_score(true_masks, predicted_masks))
